              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <>
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g. Rishabh Kashyap"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="h-11 w-full rounded-xl border border-stone-200 bg-white px-3 text-sm text-stone-900 placeholder:text-stone-400 focus:border-[#074635] focus:outline-none focus:ring-1 focus:ring-[#074635] dark:border-[#193c30] dark:bg-[#0f231c] dark:text-white"
                        />
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={mode === "login" && isAdminLogin ? "admin@scholarhub.in" : "you@example.com"}
                    className="h-11 w-full rounded-xl border border-stone-200 bg-white px-4 text-sm text-stone-900 placeholder:text-stone-400 focus:border-[#074635] focus:outline-none focus:ring-1 focus:ring-[#074635] dark:border-[#193c30] dark:bg-[#0f231c] dark:text-white"
                  />
                </div>
